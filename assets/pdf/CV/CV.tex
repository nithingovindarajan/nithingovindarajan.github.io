...
\years{Oct. 2014 - Dec. 2018}\textsc{PhD} in Mechanical Engineerings, University of California in Santa Barbara
...
\end{adjustwidth}
\years{Sep. 2009 - Oct. 2012}\textsc{MSc} in Aerospace Engineering (with honors), Technische Universiteit Delft 
\begin{adjustwidth}{2.5em}{0pt}
...
\end{adjustwidth}
\years{Jul. 2009}\textsc{BSc} in Aerospace Engineering (with honors), Technische Universiteit Delft 
...
Matlab, Python, Mathematica, C++ (basic), Julia, Latex, Git.
