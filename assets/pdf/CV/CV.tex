...
\end{adjustwidth}
\years{Sep. 2006 - Jul. 2009}\textsc{BSc} in Aerospace Engineering (with distinction), Technische Universiteit Delft 

\section*{Work experience}
\years{Nov. 2023 - present} Founder, VGN Computational consultancy services: numerical algorithms, scientific computing, and research software development.\\
\years{Nov. 2018 - present} Co-founder and technical lead, \url{www.matisse.ai}: development of production software for AI-assisted dental applications.\\
\years{Aug. 2019 - Feb. 2026} Postdoctoral researcher, KU Leuven, Belgium \\
\years{Feb. 2019 - July 2019} Lecturer Mathematics, University of Amsterdam (UvA), The Netherlands \\
\years{Nov. 2012 - May 2013} Junior R\&D engineer, National Aerospace Laboratory (NLR), Amsterdam, The Netherlands \\
\years{Sep. 2011 - May 2012} Intern, Mission Critical Technologies Inc. (on site at NASA Ames), Moffet Field, CA 

\section*{Selected software and numerical development}
\years{2022 - present} One of the main developers of \textbf{PyTensorlab}, a Python package for tensor computations: implemented numerical routines, research prototypes, and user-facing scientific software. \href{https://pytensorlab.net/}{pytensorlab.net}\\
\years{2024 - present} Developed \textbf{SSSMatrices} in Julia for sequentially semi-separable matrix representations, including conversion from dense matrices, matrix arithmetic, and linear-system solvers. \href{https://github.com/nithingovindarajan/SSSmatrices}{GitHub repository}\\
\years{2022 - present} Developed and validated fast algorithms for Macaulay nullspaces and structured linear algebra, with reproducible code accompanying SIAM publications and technical reports.\\
\years{2014 - present} Research software for numerical PDEs, dynamical systems, tensor methods, and low-rank structured matrix algorithms in Matlab, Python, and Julia.
...
\years{2025}Govindarajan, N.,  Chandrasekaran, S., Dewilde Lathauwer, L. (2025). Tree Quasi-separable Matrices: A Simultaneous Generalization of Sequentially and Hierarchically Semiseparable Representations. SIAM Journal on Matrix Analysis and Applications, 46(2), 1562-1586. \\
...
\years{2026} Govindarajan, N., Vervliet, N., Widdershoven, R., De Lathauwer, L. (2026). Efficient Krylov methods for overdetermined polynomial systems. Technical Report 26-108, ESAT-STADIUS, KU Leuven, Leuven, Belgium.\\
\years{2025} Widdershoven, R., Govindarajan, N., De Lathauwer, L. (2025). Fast Macaulay null space through the intersection of shifted null spaces. Technical Report 25-56, ESAT-STADIUS, KU Leuven.  
\years{2019} Chandrasekaran, S., Epperly, E. N., Govindarajan, N. (2019). Graph-induced rank structures and their representations. arXiv preprint arXiv:1911.05858.   

\subsection*{Selected talks}
\noindent
\years{2024} ``Macaulay matrices, low displacement rank, and the efficient computation of null spaces'', Back to the roots seminar, Leuven. \\
...
\years{2018} ``Spline-based separable expansions for approximation, regression and classiﬁcation'',  IPAM Workshop I: Tensor Methods and their Applications in the Physical and Data Sciences, UCLA (online) \\ 
